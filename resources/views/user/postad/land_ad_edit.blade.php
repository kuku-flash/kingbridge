  ...
  <div class="container">
   ...
   <div class="col-xl-10 col-lg-8 col-sm-12 col-12 rounded">
    ...
    <div class="form-group" >
      ...
      <input type="text" name="title" value="{{ $land_ad->title }}" class="form-control  @error('title') is-invalid  @enderror">
        @error('title')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
    ...
    <label class="label-control">Choose Ad Post Type</label>
      <select name="ads_type" class="form-control  @error('ads_type') is-invalid  @enderror">
         <option> {{ $land_ad->ads_type }} </option>
         <option>Sale</option>
         <option>Rent</option>
    ...
    <div class="form-group">
      ...
      <div class="form-group" >
        ...
        <input type="text" name="condition" value="{{ $land_ad->condition }}"  class="form-control  @error('condition') is-invalid  @enderror">
          @error('condition')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <input type="number" name="price" value="{{ $land_ad->price }}" class="form-control  @error('price') is-invalid  @enderror">
          @error('price')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <input type="number" name="bedroom" value="{{ $land_ad->bedroom }}" class="form-control  @error('bedroom') is-invalid  @enderror">
          @error('bedroom')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <input type="number" name="bathroom" value="{{ $land_ad->bathroom }}" class="form-control  @error('bathroom') is-invalid  @enderror">
          @error('bathroom')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        <label class="label-control"> Square Meters</label>
        <input type="number" name="square_meters" value="{{ $land_ad->square_meters }}" class="form-control  @error('square_meters') is-invalid  @enderror">
          @error('square_meters')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <input type="file" name="photos" value="{{$land_ad->photos }}" multiple="true" class="form-control  @error('photos') is-invalid  @enderror">
          @error('photos')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group">
        <label class="label-control">Packages</label>
          <select name="package_id" class="form-control  @error('package_id') is-invalid  @enderror">
            <option value="{{$land_ad->package_id }}">{{$land_ad->Package->package_name }}{{$land_ad->Package->package_amount }}</option>
